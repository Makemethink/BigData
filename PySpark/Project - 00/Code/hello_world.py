...
rdd = spark.sparkContext.textFile('./../Source/sample.txt')
...
reduced_rdd.coalesce(1).saveAsTextFile("./../../outputs/HelloWorld/Output")

# saveAsTextFile will create a directory and make file as part00001
